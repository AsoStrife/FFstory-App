 ...
 */
$config['site_title']                 = "Laore";       // Site Title, example.com
$config['admin_email']                = "admin@laore.com"; // Admin Email, admin@example.com
$config['default_group']              = 'profileB';           // Default group, use name
